...
\033[1;91m [⚡\033[1;97mAuthor Name: MR-RAJIB-SORKAR-😈     ⚡\033[1;91m]
\033[1;91m [⚡\033[1;97mYutube Chnl: MR-RAJIB-SORKAR-😈 ⚡\033[1;91m]
...
\033[1;95m«-_-_-_-_-_-_-_-_-\033[1;91mMD ARIF\033[1;95m-_-_-_-_-_-_-_-_-»
 """
CorrectUsername = "RAJIB"
CorrectPassword = "RAJIB"
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #RAJIB
	    time.sleep(2)
            loop = 'false'
        else:
...
def pilih_super():
	...
	if peak =="":
		...
		os.system('clear')
		print "\033[1;95m«-_-_-_-_-_-_-_-_-\033[1;91mRAJIB\033[1;95m-_-_-_-_-_-_-_-_-»"
		print logo
